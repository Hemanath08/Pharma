...
<body>
    ...
    <div class="banner">
        <div class="navbar">
            <h1 class="logo">Hemanath<span>Software</span></h1>
            <ul>
    ...
    <footer>
        <p>Designed and Developed by Hemanath Software Company @2024</p>
    </footer>
</body>
</html>
```
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="bitdefener.jpg" class="card-img-top" alt="Image">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="kapersky.jpg" class="card-img-top" alt="Image">
                    <div class="card-body">
...
<body>
    ...
    <div class="container">
        <div class="partner-card">
            <div class="partner-image">
                <img src="sundar pichai.jpg" alt="Partner 1">
            </div>
    ...
    <div class="container">
        ...
        <div class="partner-card">
            <div class="partner-image">
                <img src="jeff bezos.jpg" alt="Partner 5">
            </div>
            <div class="partner-name">JEFF BEZOS</div>
        </div>
        <div class="partner-card">
            <div class="partner-image">
                <img src="hemanath.jpg" alt="Partner 6">
            </div>
            <div class="partner-name">HEMANATH</div>
        </div>
    </div>
...
<body>
    ...
    <div class="container">
        ...
        <p><strong>Company Name:</strong>HEMANATH SOFTWARE SOLUTIONS</p>
        <p><strong>Address:</strong>NO:442 5th Cross Anna Nagar, Chennai-600023</p>
        <p><strong>Phone:</strong> +1 (123) 456-7890</p>
        <p><strong>Email:</strong> hemanathsoftwaresols@yahoo.com</p>
...
<body>
  <header>
    <h1>Hemanath Software Solutions PVT. LTD.</h1>
    <nav>
      <ul>
  ...
  <footer>
    <p>&copy; Hemanath Software Solutions Pvt. Ltd. 2024. All Rights Reserved.</p>
  </footer>
</body>
</html>
</body>
